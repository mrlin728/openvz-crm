...
Flat white, neutral greys, and one brand cobalt (`#2A2AFF`) — the same blue as
the OPENVZ AI site. The greys are
...
carries the brand, but a ring only has to be seen, and `#2A2AFF` is too close to
the dark background to register. Dark lightens it to `#7C7CFF`.