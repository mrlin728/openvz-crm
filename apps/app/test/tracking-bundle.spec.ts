...
import type { TrackingConfig } from "@openvz/db/tracking";
...
const CONFIG: TrackingConfig = {
	...
	hosts: [
		...
		{ host: "www.openvzai.com", scope: "EXACT_HOST" },
		{ host: "docs.openvzai.com", scope: "EXACT_HOST" },
		{ host: "app.openvzai.com", scope: "EXACT_HOST" },
	],
};
...
describe("the loader finds the site id however the page was built", () => {
	...
	test("the tracker bakes the config in rather than fetching it", () => {
		...
		expect(source).toContain("docs.openvzai.com");
