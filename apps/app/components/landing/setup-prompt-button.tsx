...
import ClaudeLogo from "@openvz/ui/components/brand-logos/claude";
import { Button } from "@openvz/ui/components/button";
import { useState } from "react";
import { type CtaLocation, captureLanding } from "./analytics";

const SETUP_PROMPT =
	"Set up openvzai/crm — install the dependencies, start Postgres, create my .env, and tell me which keys I still need.";
