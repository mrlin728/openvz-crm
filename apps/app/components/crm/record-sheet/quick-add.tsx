...
import { DatePicker } from "@openvz/ui/components/date-picker";
...
function QuickAddForm({
	...
	const t = useTranslations("crm.quickAdd");
	return (
		<form
...
export function QuickAddContact({
	...
	return (
		...
		>
			...
			<Field>
				<FieldLabel htmlFor={titleId}>{t("jobTitle")}</FieldLabel>
				<Input
					id={titleId}
					value={title}
		...
		>
			<Field className="sm:col-span-2">
				...
				<Input
					...
					placeholder={`${companyName} — OPENVZ AI`}
					autoComplete="off"
				/>
			</Field>
			<Field>
