<h1 align="center">OPENVZ CRM</h1>

<p align="center">
  <strong>An open-source CRM built for AI agents.</strong><br>
...
<p align="center">
  <img alt="MIT licence" src="https://img.shields.io/badge/licence-MIT-2A2AFF.svg">
...
<p align="center">
  <sub>OPENVZ CRM is a product of <a href="https://www.openvzai.com">OPENVZ AI</a>. It is a
  derivative of an MIT-licensed codebase — see <a href="./NOTICE">NOTICE</a>.</sub>
</p>
...
```sh
git clone https://github.com/mrlin728/openvz-crm.git && cd openvz-crm
...
| `OPENVZ_TELEMETRY_ENABLED` | Telemetry is **off** unless you set this to `1`. It also needs `OPENVZ_POSTHOG_KEY` before it has anywhere to send. |
